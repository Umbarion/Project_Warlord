...
*/
private ["_item_list","_gear_list","_shopItems","_name","_price","_itemx","_itemInfo","_gearInfo","_val"];
...

{
    ...
    if (!(_price isEqualTo -1)) then {
        ...
        _item_list lbAdd format ["%1 ($%2)",_itemInfo select 1,[_price] call life_fnc_numberText];
