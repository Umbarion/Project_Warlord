...
*/
private ["_vendor","_type","_itemInfo","_success","_oldItem","_newItemWeight","_newItem","_itemx","_oldItemWeight","_cost","_upp","_hasLicense","_itemName","_oldVal","_ui","_progress","_pgText","_cP","_materialsRequired","_materialsGiven","_noLicenseCost","_text","_filter","_totalConversions","_minimumConversions"];
